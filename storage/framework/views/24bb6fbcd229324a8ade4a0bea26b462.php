      ...
      <div class="stats-card" style="border-radius: 20px; padding: 24px; background: var(--card-bg); backdrop-filter: blur(20px); border: 1px solid var(--border); box-shadow: var(--shadow); transition: all 0.3s; position: relative; overflow: hidden;" onmouseover="this.style.background='var(--card-bg-hover)'; this.style.transform='translateY(-4px)'; this.style.boxShadow='var(--shadow-lg)'" onmouseout="this.style.background='var(--card-bg)'; this.style.transform='translateY(0)'; this.style.boxShadow='var(--shadow)'">
        ...
        <div style="display: flex; align-items: center; justify-content: space-between; margin-top: 8px;">
          <div style="flex: 1;">
            ...
            <p style="color: var(--text-primary); font-size: 2rem; font-weight: 800; background: linear-gradient(135deg, #6366f1, #8b5cf6); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text; margin: 0.5rem 0;"><?php echo e($activities->count()); ?></p>
      ...
      <div class="stats-card" style="border-radius: 20px; padding: 24px; background: var(--card-bg); backdrop-filter: blur(20px); border: 1px solid var(--border); box-shadow: var(--shadow); transition: all 0.3s; position: relative; overflow: hidden;" onmouseover="this.style.background='var(--card-bg-hover)'; this.style.transform='translateY(-4px)'; this.style.boxShadow='var(--shadow-lg)'" onmouseout="this.style.background='var(--card-bg)'; this.style.transform='translateY(0)'; this.style.boxShadow='var(--shadow)'">
        ...
        <div style="display: flex; align-items: center; justify-content: space-between; margin-top: 8px;">
          <div style="flex: 1;">
            ...
            <p style="color: var(--text-primary); font-size: 2rem; font-weight: 800; background: linear-gradient(135deg, #10b981, #06b6d4); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text; margin: 0.5rem 0;"><?php echo e($activities->where('type', 'job_created')->count()); ?></p>
      ...
      <div class="stats-card" style="border-radius: 20px; padding: 24px; background: var(--card-bg); backdrop-filter: blur(20px); border: 1px solid var(--border); box-shadow: var(--shadow); transition: all 0.3s; position: relative; overflow: hidden;" onmouseover="this.style.background='var(--card-bg-hover)'; this.style.transform='translateY(-4px)'; this.style.boxShadow='var(--shadow-lg)'" onmouseout="this.style.background='var(--card-bg)'; this.style.transform='translateY(0)'; this.style.boxShadow='var(--shadow)'">
        ...
        <div style="display: flex; align-items: center; justify-content: space-between; margin-top: 8px;">
          <div style="flex: 1;">
            ...
            <p style="color: var(--text-primary); font-size: 2rem; font-weight: 800; background: linear-gradient(135deg, #6366f1, #8b5cf6); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text; margin: 0.5rem 0;"><?php echo e($activities->where('type', 'message_sent')->count()); ?></p>
      ...
      <div class="stats-card" style="border-radius: 20px; padding: 24px; background: var(--card-bg); backdrop-filter: blur(20px); border: 1px solid var(--border); box-shadow: var(--shadow); transition: all 0.3s; position: relative; overflow: hidden;" onmouseover="this.style.background='var(--card-bg-hover)'; this.style.transform='translateY(-4px)'; this.style.boxShadow='var(--shadow-lg)'" onmouseout="this.style.background='var(--card-bg)'; this.style.transform='translateY(0)'; this.style.boxShadow='var(--shadow)'">
        ...
        <div style="display: flex; align-items: center; justify-content: space-between; margin-top: 8px;">
          <div style="flex: 1;">
            ...
            <p style="color: var(--text-primary); font-size: 2rem; font-weight: 800; background: linear-gradient(135deg, #f59e0b, #f97316); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text; margin: 0.5rem 0;"><?php echo e($activities->where('type', 'payment_made')->count()); ?></p>
      ...
      <div style="position: relative;">
        ...
        <div style="padding: 24px; display: flex; flex-direction: column; gap: 24px;" id="activityContainer">
          ...
          <div class="activity-item activity-card" 
               data-type="<?php echo e($activity['type']); ?>" 
               data-user="<?php echo e(strtolower($activity['user']->name ?? '')); ?>"
               data-description="<?php echo e(strtolower($activity['description'] ?? '')); ?>"
            ...
            <div style="background: rgba(255,255,255,0.03); backdrop-filter: blur(20px); border-radius: 16px; padding: 24px; border: 1px solid var(--border); transition: all 0.3s;"
              ...
              <div style="display: flex; align-items: flex-start; gap: 16px;">
                ...
                <div class="flex-shrink-0">
                  <?php if($activity['type'] == 'job_created'): ?>
                  ...
                  <?php elseif($activity['type'] == 'payment_made'): ?>
                  ...
                  <div class="flex items-center justify-between mb-2">
                    ...
                    <div class="text-right">
                      ...
                      <p style="font-size: 0.75rem; color: var(--text-muted);">
                        <?php echo e($activity['timestamp']->format('M j, Y g:i A')); ?>

                      </p>
                    </div>
                  </div>
                  
                  <p style="color: var(--text-primary); margin-bottom: 1rem;"><?php echo e($activity['description']); ?></p>

                  <!-- Additional Details -->
                  <?php if(isset($activity['data'])): ?>
                  <div class="flex flex-wrap gap-2">
                    <?php if($activity['type'] == 'job_created'): ?>
                      <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-green-500/20 text-green-300 border border-green-500/30">
                        Job ID: <?php echo e($activity['data']->id); ?>

                      </span>
                      <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-green-500/20 text-green-300 border border-green-500/30">
                        Budget: Tsh <?php echo e(number_format($activity['data']->budget ?? 0)); ?>
                    ...
                    <?php elseif($activity['type'] == 'message_sent'): ?>
                      <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-blue-500/20 text-blue-300 border border-blue-500/30">
                        Message ID: <?php echo e($activity['data']->id); ?>

                      </span>
                      <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-blue-500/20 text-blue-300 border border-blue-500/30">
                        To: <?php echo e($activity['data']->receiver->name ?? 'Unknown'); ?>
                    ...
                    <?php elseif($activity['type'] == 'payment_made'): ?>
                      <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-orange-500/20 text-orange-300 border border-orange-500/30">
                        Payment ID: <?php echo e($activity['data']->id); ?>

                      </span>
                      <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-orange-500/20 text-orange-300 border border-orange-500/30">
                        Amount: Tsh <?php echo e(number_format($activity['data']->amount ?? 0)); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/eunice/GITHUB COOP/Tendapoa2/resources/views/admin/system-logs.blade.php ENDPATH**/ ?>
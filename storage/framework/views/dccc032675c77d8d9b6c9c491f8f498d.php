<?php $__env->startSection('title', 'Wasifu Wangu'); ?>
    ...
    <main class="main-content">
        ...
        <div class="profile-grid">
            ...
            <div class="glass-card profile-photo-wrapper">
                <form method="post" action="<?php echo e(route('profile.update')); ?>" enctype="multipart/form-data" id="photo-form">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="profile-photo-container">
                        <img src="<?php echo e($user->profile_photo_url); ?>" alt="<?php echo e($user->name); ?>" class="profile-photo" id="preview-image" onerror="this.src='https://ui-avatars.com/api/?name=<?php echo e(urlencode($user->name)); ?>&color=7F9CF5&background=EBF4FF'">
...
$message = $__bag->first($__errorArgs[0]); ?>
                        <div style="color: var(--danger); font-size: 0.85rem; text-align: center; margin-top: 10px;"><?php echo e($message); ?></div>
                    <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="user-meta">
                    ...
                    <p style="color: #64748b; margin-top: 8px;"><?php echo e($user->email); ?></p>
                    <p style="color: #64748b; font-size: 0.9rem;"><?php echo e($user->phone ?? 'Hakuna namba ya simu'); ?></p>
                </div>
            </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="phone" name="phone" class="form-input" value="<?php echo e(old('phone', $user->phone)); ?>" placeholder="07xxxxxxxx">
...
<script>
    ...
    function cancelPhotoUpload() {
        ...
        previewImage.src = '<?php echo e($user->profile_photo_url); ?>';
    }
    ...
    <?php if(session('status') === 'profile-updated'): ?>
        ...
        setTimeout(function() {
            ...
            previewImage.src = '<?php echo e($user->profile_photo_url); ?>&t=' + timestamp;
        }, 500);
    <?php endif; ?>
</script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/eunice/GITHUB COOP/Tendapoa2/resources/views/profile/edit.blade.php ENDPATH**/ ?>
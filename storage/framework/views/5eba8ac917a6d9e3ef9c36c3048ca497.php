<?php $__env->startSection('title', 'Admin — Dashibodi ya muhitaji'); ?>
...
<div class="adm-subpage adm-stack">
    ...
    <div class="adm-stat-row">
        ...
        <div class="adm-stat-card">
            ...
            <div class="adm-v" style="color:var(--adm-warning);"><?php echo e($stats['active_jobs']); ?></div>
        </div>
        <div class="adm-stat-card">
    ...
    <div class="adm-card">
        ...
        <?php else: ?>
                        ...
                        <div style="min-width:0;flex:1;">
                            ...
                            <?php if($job->acceptedWorker): ?>
                                <p style="margin:0.35rem 0 0;font-size:var(--adm-text-sm);color:var(--adm-muted);">
                                    Mfanyakazi: <a href="<?php echo e(route('admin.user.details', $job->acceptedWorker)); ?>" style="color:var(--adm-primary);font-weight:600;"><?php echo e($job->acceptedWorker->name); ?></a>
                                </p>
                            <?php endif; ?>
                        </div>
            ...
            <div class="adm-pagination"><?php echo e($jobs->links()); ?></div>
        <?php endif; ?>
    </div>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/eunice/GITHUB COOP/Tendapoa2/resources/views/admin/user-dashboard-muhitaji.blade.php ENDPATH**/ ?>
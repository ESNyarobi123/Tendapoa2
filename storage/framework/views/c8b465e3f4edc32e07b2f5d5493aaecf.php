<?php $__env->startSection('title', 'System Settings - Admin'); ?>
    ...
    <div class="settings-section">
      ...
      <div class="form-grid">
        <div class="form-group">
          ...
          <input type="text" id="platform_name" name="platform_name" value="<?php echo e($settings['platform_name'] ?? 'Tendapoa'); ?>" class="form-input">
        </div>

        <div class="form-group">
          <label class="form-label" for="platform_version">Platform Version</label>
          <input type="text" id="platform_version" name="platform_version" value="<?php echo e($settings['platform_version'] ?? '1.0.0'); ?>" class="form-input">
        </div>

        <div class="form-group">
          <label class="form-label" for="system_currency">System Currency</label>
          <input type="text" id="system_currency" name="system_currency" value="<?php echo e($settings['system_currency'] ?? 'TZS'); ?>" class="form-input">
        </div>

        <div class="form-group">
          <label class="form-label" for="contact_email">Support Email</label>
          <input type="email" id="contact_email" name="contact_email" value="<?php echo e($settings['contact_email'] ?? 'support@tendapoa.com'); ?>" class="form-input">
        </div>
        ...
        <div class="form-group">
          ...
          <?php if(isset($settings['platform_logo'])): ?>
            <div style="margin-top: 8px; display: flex; align-items: center; gap: 12px;">
              <img src="<?php echo e(asset('storage/' . $settings['platform_logo'])); ?>" alt="Logo" style="height: 40px; border-radius: 8px; background: rgba(255,255,255,0.1); padding: 4px;">
      ...
      <div class="form-group" style="margin-top: 24px;">
        ...
        <textarea id="platform_description" name="platform_description" rows="3" class="form-textarea"><?php echo e($settings['platform_description'] ?? 'Tendapoa - Your trusted platform for connecting job seekers with employers'); ?></textarea>
      </div>
    </div>
    ...
    <div class="settings-section">
      ...
      <div class="form-grid">
        <div class="form-group">
          ...
          <input type="number" id="commission_rate" name="commission_rate" value="<?php echo e($settings['commission_rate'] ?? '10'); ?>" step="0.1" class="form-input">
          <small style="color: var(--text-muted);">This percentage is deducted from worker earnings upon job completion.</small>
        </div>

        <div class="form-group">
          <label class="form-label" for="min_withdrawal">Minimum Withdrawal (<?php echo e($settings['system_currency'] ?? 'TZS'); ?>)</label>
          <input type="number" id="min_withdrawal" name="min_withdrawal" value="<?php echo e($settings['min_withdrawal'] ?? '10000'); ?>" class="form-input">
        </div>

        <div class="form-group">
          <label class="form-label" for="withdrawal_fee">Withdrawal Fee (<?php echo e($settings['system_currency'] ?? 'TZS'); ?>)</label>
          <input type="number" id="withdrawal_fee" name="withdrawal_fee" value="<?php echo e($settings['withdrawal_fee'] ?? '500'); ?>" class="form-input">
        </div>

        <div class="form-group">
          <label class="form-label" for="job_posting_fee">Job Posting Fee (<?php echo e($settings['system_currency'] ?? 'TZS'); ?>)</label>
          <input type="number" id="job_posting_fee" name="job_posting_fee" value="<?php echo e($settings['job_posting_fee'] ?? '0'); ?>" class="form-input">
        </div>
      </div>
    </div>
      ...
      <div style="display: grid; gap: 16px;">
        <div class="toggle-group">
          ...
          <label class="toggle-switch">
            <input type="checkbox" name="payments_enabled" <?php echo e(($settings['payments_enabled'] ?? '1') == '1' ? 'checked' : ''); ?>>
        ...
        <div class="toggle-group">
          ...
          <label class="toggle-switch">
            <input type="checkbox" name="maintenance_mode" <?php echo e(($settings['maintenance_mode'] ?? '0') == '1' ? 'checked' : ''); ?>>
            <span class="toggle-slider"></span>
          </label>
        </div>
        ...
        <div class="toggle-group">
          ...
          <label class="toggle-switch">
            <input type="checkbox" name="registration_enabled" <?php echo e(($settings['registration_enabled'] ?? '1') == '1' ? 'checked' : ''); ?>>
            <span class="toggle-slider"></span>
          </label>
        </div>
      </div>
    ...
    <div class="settings-section">
      ...
      <div style="display: grid; gap: 16px;">
        <div class="toggle-group">
          ...
          <label class="toggle-switch">
            <input type="checkbox" name="email_notifications" <?php echo e(($settings['email_notifications'] ?? '1') == '1' ? 'checked' : ''); ?>>
            <span class="toggle-slider"></span>
          </label>
        </div>
        ...
        <div class="toggle-group">
          ...
          <label class="toggle-switch">
            <input type="checkbox" name="sms_notifications" <?php echo e(($settings['sms_notifications'] ?? '0') == '1' ? 'checked' : ''); ?>>
            <span class="toggle-slider"></span>
          </label>
        </div>
        ...
        <div class="toggle-group">
          ...
          <label class="toggle-switch">
            <input type="checkbox" name="push_notifications" <?php echo e(($settings['push_notifications'] ?? '1') == '1' ? 'checked' : ''); ?>>
            <span class="toggle-slider"></span>
          </label>
        </div>
      </div>
  ...
  <div class="settings-section">
      ...
      <div style="background: rgba(16, 185, 129, 0.1); border: 2px solid rgba(16, 185, 129, 0.3); border-radius: 12px; padding: 20px; margin-bottom: 24px;">
        ...
        <div style="display: grid; gap: 8px;">
          <div><strong>Version:</strong> <?php echo e($activeVersion->version); ?></div>
          <div><strong>File:</strong> <?php echo e($activeVersion->file_name); ?></div>
          <div><strong>Size:</strong> <?php echo e(number_format($activeVersion->file_size / 1024 / 1024, 2)); ?> MB</div>
          <?php if($activeVersion->description): ?>
          <div><strong>Description:</strong> <?php echo e($activeVersion->description); ?></div>
          <?php endif; ?>
          <div><strong>Uploaded:</strong> <?php echo e($activeVersion->created_at->format('Y-m-d H:i')); ?></div>
        </div>
      </div>
      <?php else: ?>
      ...
      <div style="margin-top: 32px; padding-top: 24px; border-top: 1px solid var(--border);">
        ...
        <form action="<?php echo e(route('admin.apk.scan')); ?>" method="POST">
          <?php echo csrf_field(); ?>
      ...
      <?php if($allVersions->count() > 0): ?>
      <div style="margin-top: 32px;">
        <h3 style="color: var(--text-primary); font-size: 1rem; font-weight: 700; margin-bottom: 16px;">Previous Versions</h3>
        <div style="display: grid; gap: 12px;">
          <?php $__currentLoopData = $allVersions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $version): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <div style="background: rgba(255,255,255,0.03); border: 1px solid var(--border); border-radius: 8px; padding: 16px; display: flex; justify-content: space-between; align-items: center;">
            <div>
              <div style="font-weight: 600; color: var(--text-primary);"><?php echo e($version->version); ?></div>
              <div style="font-size: 0.875rem; color: var(--text-muted); margin-top: 4px;">
                <?php echo e($version->file_name); ?> (<?php echo e(number_format($version->file_size / 1024 / 1024, 2)); ?> MB)
              </div>
            ...
            <div style="font-size: 0.875rem; color: var(--text-muted);">
              <?php echo e($version->created_at->format('Y-m-d')); ?>
...
<script>
  ...
  (function () {
    var f = document.querySelector('form[action="<?php echo e(route('admin.system-settings.update')); ?>"]');
    if (!f) return;
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    try {
      ...
      // Send request
      const uploadUrl = '<?php echo e(route('admin.apk.upload')); ?>';
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/eunice/GITHUB COOP/Tendapoa2/resources/views/admin/system-settings.blade.php ENDPATH**/ ?>
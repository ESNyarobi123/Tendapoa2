<?php $__env->startSection('title', 'Inahakiki Deposit'); ?>
  ...
  <main class="main-content">
    <div class="page-container">
      <div class="card">
        ...
        <p>Kiasi: <b><?php echo e(number_format($transaction->meta['requested'] ?? 0)); ?> TZS</b></p>
        <div id="st" class="badge">INASUBIRI</div>
        <div class="spinner" id="spinner"></div>
        <p id="status-text">Inahakiki malipo...</p>

        <div style="margin-top:24px;">
          <a href="<?php echo e(route('wallet.deposit')); ?>" class="btn btn-outline">↩️ Rudi kwenye Deposit</a>
        </div>
      </div>
    </div>
  </main>
...
<script>
  ...
  setInterval(async () => {
    ...
    try {
      const r = await fetch('<?php echo e(route("wallet.deposit.poll", $transaction)); ?>?t=' + Date.now());
      ...
      if (j.status === 'COMPLETED') {
        ...
        txt.dataset.done = '1';
        setTimeout(() => location.href = '<?php echo e(route("dashboard")); ?>', 1500);
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/eunice/GITHUB COOP/Tendapoa2/resources/views/wallet/deposit-wait.blade.php ENDPATH**/ ?>
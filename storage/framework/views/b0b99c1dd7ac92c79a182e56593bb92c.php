  ...
  <main class="main-content">
    ...
    <div class="job-hero">
      <div class="job-hero-image-container">
        ...
        <?php if($imageUrl): ?>
          <img src="<?php echo e($imageUrl); ?>" alt="<?php echo e($job->title); ?>" class="job-hero-image"
      ...
      <div class="job-price-badge">
        <?php echo e(number_format($job->price)); ?> <small>TZS</small>
      </div>
      
      <!-- Status Badge -->
      <div class="job-status-badge <?php echo e(str_replace('_', '-', $job->status)); ?>">
        <?php switch($job->status):
          case ('open'): ?> 📋 Wazi - Inapokea Maombi <?php break; ?>
          ...
          <?php case ('disputed'): ?> ⚠️ Mgogoro <?php break; ?>
          <?php case ('cancelled'): ?> 🚫 Imefutwa <?php break; ?>
          <?php case ('refunded'): ?> 💸 Imerudishwa <?php break; ?>
          <?php case ('expired'): ?> ⏰ Imepitwa <?php break; ?>
          <?php case ('posted'): ?> 📋 Imechapishwa <?php break; ?>
          <?php case ('assigned'): ?> 👷 Imepewa Mfanyakazi <?php break; ?>
      ...
      <div class="job-hero-overlay">
        <div class="job-hero-info">
          <div class="job-badges">
            <div class="badge badge-category"><?php echo e($job->category->name); ?></div>
          ...
          <div class="job-poster-info">
            <div class="job-poster-avatar">
              <?php if($job->poster_type === 'mfanyakazi'): ?> 👷 <?php else: ?> 👤 <?php endif; ?>
            </div>
            <div>
              <span><?php echo e($job->poster_type === 'mfanyakazi' ? 'Mfanyakazi' : 'Muhitaji'); ?>:</span>
              <span class="job-poster-name"><?php echo e($job->muhitaji->name); ?></span>
    ...
    <?php if(auth()->guard()->check()): ?>
      <?php if(auth()->user()->role === 'mfanyakazi' && (int) auth()->id() !== (int) $job->user_id && $job->status === \App\Models\Job::S_OPEN): ?>
        <?php
          $heroWorkerApp = $job->applications->first(fn ($a) => (int) $a->worker_id === (int) auth()->id() && ! in_array($a->status, ['withdrawn', 'rejected'], true));
        ?>
        <?php if (! ($heroWorkerApp)): ?>
      ...
      <div>
        ...
        <div class="job-card" style="margin-bottom: 16px;">
          ...
          <p class="job-description-text">
            <?php echo e($job->description ?? 'Hakuna maelezo ya ziada yaliyowekwa kwa kazi hii.'); ?>
          ...
          <div class="price-box">
            ...
            <div class="price-box-amount"><?php echo e(number_format($job->price)); ?> <small style="font-size:0.55em;font-weight:600;opacity:0.8">TZS</small></div>
            <?php if(auth()->guard()->check()): ?>
              <?php if(auth()->id() === $job->user_id && (int) ($job->agreed_amount ?? 0) > 0 && in_array($job->status, ['awaiting_payment', 'funded', 'in_progress', 'submitted', 'completed', 'disputed', 'refunded'], true)): ?>
                <div class="price-box-agreed">
                  <div class="price-box-agreed-label">Bei iliyokubaliwa (escrow)</div>
                  <div class="price-box-agreed-amt"><?php echo e(number_format($job->agreed_amount)); ?> TZS</div>
                </div>
              <?php endif; ?>
            <?php endif; ?>
            <p class="price-box-note">
              <?php if(auth()->guard()->check()): ?>
                ...
                <?php elseif(auth()->user()->role === 'mfanyakazi'): ?>
            ...
            <?php if(auth()->check() && auth()->user()->role === 'mfanyakazi'): ?>
          ...
          <?php if(auth()->guard()->check()): ?>
            ...
            <?php if($isClient): ?>
              <div class="job-flow-banner" id="flow-anchor">
                ...
                <?php if($job->status === \App\Models\Job::S_OPEN): ?>
                  ...
                  <p style="margin:12px 0 0;font-size:0.8rem;color:var(--job-text-muted);">Orodha ya maombi yote: <a href="<?php echo e(route('my.applications')); ?>" style="color:var(--job-primary);font-weight:700;">Maombi yangu</a></p>
                <?php elseif($job->status === \App\Models\Job::S_AWAITING_PAYMENT): ?>
                ...
                <?php elseif(in_array($job->status, [\App\Models\Job::S_FUNDED, \App\Models\Job::S_IN_PROGRESS, \App\Models\Job::S_SUBMITTED], true)): ?>
                  ...
                  <ul class="job-flow-steps">
                    ...
                    <li class="<?php echo e($job->status === \App\Models\Job::S_FUNDED ? 'is-current' : 'is-done'); ?>"><span class="step-idx"><?php echo e($job->status === \App\Models\Job::S_FUNDED ? '!' : '✓'); ?></span><span>Mfanyakazi anakubali / anafanya kazi</span></li>
                    <li class="<?php echo e($job->status === \App\Models\Job::S_IN_PROGRESS ? 'is-current' : ($job->status === \App\Models\Job::S_SUBMITTED ? 'is-done' : '')); ?>"><span class="step-idx">3</span><span>Wasilisho la kazi</span></li>
                    <li class="<?php echo e($job->status === \App\Models\Job::S_SUBMITTED ? 'is-current' : ''); ?>"><span class="step-idx">4</span><span><strong>Thibitisha</strong> au omba marekebisho</span></li>
                  </ul>
                  <?php if($job->status === \App\Models\Job::S_IN_PROGRESS && $job->completion_code): ?>
                  ...
                  <?php endif; ?>
                <?php elseif($job->status === \App\Models\Job::S_COMPLETED): ?>
                  <p class="job-flow-banner-title">Kazi imekamilika. Asante kwa kutumia TendaPoa.</p>
                <?php else: ?>
                  <p class="job-flow-banner-title">Hali ya kazi: <?php echo e(str_replace('_', ' ', $job->status)); ?>. Fuata maelezo hapa chini.</p>
                <?php endif; ?>
              </div>
            <?php elseif($isWorker && ! $isClient): ?>
              <div class="job-flow-banner" id="flow-anchor">
                <div class="job-flow-banner-kicker">Wewe ni mfanyakazi</div>
                <?php if($job->status === \App\Models\Job::S_OPEN && ! $myApplication): ?>
                ...
                <?php elseif($myApplication && $job->status === \App\Models\Job::S_OPEN): ?>
                  <p class="job-flow-banner-title">Ombi lako limewasilishwa. Fuatilia hali kwenye <a href="<?php echo e(route('mfanyakazi.applications')); ?>" style="color:#a7f3d0;text-decoration:underline;font-weight:800;">Maombi yangu</a> au hapa chini.</p>
                  <ul class="job-flow-steps">
                ...
                <?php elseif($isSelectedWorker && $job->status === \App\Models\Job::S_AWAITING_PAYMENT): ?>
                ...
                <?php elseif($isAssignedWorker && in_array($job->status, [\App\Models\Job::S_FUNDED, \App\Models\Job::S_IN_PROGRESS, \App\Models\Job::S_SUBMITTED], true)): ?>
                  ...
                  <ul class="job-flow-steps">
                    ...
                    <li class="<?php echo e($job->status === \App\Models\Job::S_FUNDED ? 'is-current' : 'is-done'); ?>"><span class="step-idx"><?php echo e($job->status === \App\Models\Job::S_FUNDED ? '!' : '✓'); ?></span><span>Kubali na anza / fanya kazi</span></li>
                    <li class="<?php echo e($job->status === \App\Models\Job::S_IN_PROGRESS ? 'is-current' : ''); ?>"><span class="step-idx">3</span><span>Wasilisha kazi ukiisha</span></li>
                    <li class="<?php echo e($job->status === \App\Models\Job::S_SUBMITTED ? 'is-current' : ''); ?>"><span class="step-idx">4</span><span>Subiri mteja athibitishe</span></li>
                  </ul>
                <?php elseif($job->status === \App\Models\Job::S_COMPLETED): ?>
                  <p class="job-flow-banner-title">Kazi imekamilika.</p>
                <?php elseif($job->status === 'posted' && ! $myApplication): ?>
            ...
            <?php if($isMuhitaji && $workersForChat->isNotEmpty()): ?>
              <div class="chat-box">
                ...
                <div class="chat-users">
                  <?php $__currentLoopData = $workersForChat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chatWorker): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(route('chat.show', ['job' => $job, 'worker_id' => $chatWorker->id])); ?>" class="btn btn-success">
                      💬 <?php echo e($chatWorker->name); ?>
            ...
            <?php if($isWorker && ! $isMuhitaji && ($userHasCommented || $isAcceptedWorker || $isSelectedWorker || ($myApplication && $myApplication->isActive()))): ?>
              <div class="chat-box">
                <div class="chat-box-header">
                  <span class="chat-box-icon">💬</span>
                  <span class="chat-box-title">Mazungumzo na mteja</span>
                </div>
                <p class="chat-box-text">Mteja: <strong><?php echo e($job->muhitaji->name); ?></strong></p>
                <a href="<?php echo e(route('chat.show', $job)); ?>" class="btn btn-success">
                  💬 Fungua mazungumzo
                </a>
              </div>
            <?php endif; ?>
            ...
            <?php if($isWorker && ! $isClient && $job->status === \App\Models\Job::S_OPEN && ! $myApplication): ?>
              <div id="worker-apply-form" class="job-action-panel job-action-panel--apply">
                <h4>✋ Omba kufanya kazi hii</h4>
                <p class="lead">Baada ya kuwasilisha utapelekwa kwenye <a href="<?php echo e(route('mfanyakazi.applications')); ?>" style="color:var(--job-primary);font-weight:800;">Maombi yangu</a> kufuatilia hali (counter, kuchaguliwa, n.k.). Hapa hutaona maombi ya wafanyakazi wengine.</p>
                <form method="POST" action="<?php echo e(route('jobs.apply', $job)); ?>">
                  <?php echo csrf_field(); ?>
                  <div class="form-group">
                    <label class="form-label">💵 Bei unayopendekeza (TZS)</label>
                    <input type="number" name="proposed_amount" class="form-input" placeholder="10000" min="1000" step="500" required value="<?php echo e(old('proposed_amount', $job->price)); ?>" style="font-weight: 700; font-size: 1.1rem;">
                    <p style="font-size: 0.8rem; color: var(--job-text-dim); margin-top: 6px;">Bajeti ya mteja: <strong style="color: #10b981;"><?php echo e(number_format($job->price)); ?> TZS</strong></p>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="eta_text" class="form-input" placeholder="Mfano: siku 2" value="<?php echo e(old('eta_text')); ?>">
                  </div>
            ...
            <?php if($isWorker && $myApplicationAny): ?>
              <div class="job-action-panel job-action-panel--status">
                <?php if($myApplicationAny->status === \App\Models\JobApplication::STATUS_REJECTED): ?>
                  <h4 style="margin:0 0 8px;">📋 Ombi lako</h4>
                  <p style="margin:0 0 10px;font-size:0.8rem;"><a href="<?php echo e(route('mfanyakazi.applications')); ?>" style="color:var(--job-primary);font-weight:800;">→ Maombi yangu</a></p>
                ...
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 8px; flex-wrap: wrap; gap: 8px;">
                  ...
                  <span style="background: rgba(99, 102, 241, 0.2); color: #4f46e5; padding: 4px 12px; border-radius: 8px; font-size: 0.75rem; font-weight: 700;"><?php echo e($myApplicationAny->getStatusLabel()); ?></span>
                </div>
                <p style="margin:0 0 10px;font-size:0.8rem;"><a href="<?php echo e(route('mfanyakazi.applications')); ?>" style="color:var(--job-primary);font-weight:800;">→ Maombi yangu</a> (orodha yako — huioni maombi ya wengine)</p>
                <p class="lead" style="margin-bottom:8px;">Uliopendekeza: <strong>TZS <?php echo e(number_format($myApplicationAny->proposed_amount)); ?></strong></p>
                <?php if($myApplicationAny->status === \App\Models\JobApplication::STATUS_SELECTED): ?>
                ...
                <?php endif; ?>
                <?php if($myApplication && $myApplication->isCountered()): ?>
                  <div style="margin-top: 12px; padding: 14px; background: rgba(168, 85, 247, 0.12); border-radius: 12px; border: 1px solid rgba(168, 85, 247, 0.35);">
                    <div style="color: #6d28d9; font-weight: 700; font-size: 0.88rem;">🔄 Counter offer ya mteja: TZS <?php echo e(number_format($myApplication->counter_amount)); ?></div>
                    <?php if($myApplication->client_response_note): ?>
                      <p style="color: var(--job-text-muted); font-size: 0.85rem; margin: 8px 0 0;"><?php echo e($myApplication->client_response_note); ?></p>
                    <?php endif; ?>
                    ...
                    <form method="POST" action="<?php echo e(route('applications.accept-counter', [$job, $myApplication])); ?>" style="margin-top: 12px;">
                      <?php echo csrf_field(); ?>
                      <button type="submit" class="btn btn-success btn-full">✅ Kubali counter offer</button>
                    </form>
                  </div>
                <?php endif; ?>
                <?php if($myApplication && $job->status === \App\Models\Job::S_OPEN): ?>
                  <form method="POST" action="<?php echo e(route('applications.withdraw', [$job, $myApplication])); ?>" style="margin-top: 12px;">
                    <?php echo csrf_field(); ?>
            ...
            <?php if($isClient && $job->status === \App\Models\Job::S_AWAITING_PAYMENT): ?>
              <div class="job-action-panel job-action-panel--pay">
                <div style="font-size: 2rem; margin-bottom: 8px;">💳</div>
                <h4>Lipa escrow ili kuanza kazi</h4>
                <p class="lead">Umemchagua <strong><?php echo e($job->selectedWorker->name ?? 'mfanyakazi'); ?></strong>. Weka TZS <strong><?php echo e(number_format($job->agreed_amount)); ?></strong> kwenye escrow. Mfanyakazi ataarifiwa baada ya malipo.</p>
                <a href="<?php echo e(route('jobs.fund', $job)); ?>" class="btn btn-success btn-full" style="font-size: 1.05rem;">💰 Fungua ukurasa wa malipo</a>
              </div>
            <?php endif; ?>

            
            <?php if($isClient && $job->completion_code && in_array($job->status, [\App\Models\Job::S_FUNDED, \App\Models\Job::S_IN_PROGRESS], true)): ?>
              <?php
              ...
              <div class="job-action-panel job-action-panel--apply" style="border-color: rgba(16, 185, 129, 0.4); background: linear-gradient(135deg, rgba(16, 185, 129, 0.12), rgba(5, 150, 105, 0.06));">
                ...
                <p class="lead" style="margin-bottom: 12px;">
                  Hii si nenosiri la akaunti — ni <strong>nambari ya uthibitisho</strong> pekee. Mpe mfanyakazi <strong><?php echo e($workerForCode->name ?? 'aliyechaguliwa'); ?></strong> baada ya kufanya kazi vizuri; ataingiza kwenye fomu ya <em>Wasilisha kazi</em> ili kukamilisha mchakato.
                </p>
                <button type="button" onclick="tpCopyJobCode('<?php echo e($job->completion_code); ?>')" class="btn btn-full" style="font-family: ui-monospace, monospace; font-size: 1.35rem; font-weight: 800; letter-spacing: 0.35em; background: rgba(255,255,255,0.95); color: #047857; border: 2px solid rgba(16, 185, 129, 0.45); padding: 14px;">
                  <?php echo e($job->completion_code); ?>

                </button>
                <p class="lead" style="margin-top: 10px; font-size: 0.78rem; color: var(--job-text-muted);">Bonyeza nambari kunakili. Unaweza pia kuiona kwenye <a href="<?php echo e(route('my.jobs')); ?>" style="color: var(--job-primary); font-weight: 700;">Kazi zangu</a>.</p>
              </div>
            <?php endif; ?>

            
            <?php if($isSelectedWorker && $job->status === \App\Models\Job::S_AWAITING_PAYMENT): ?>
              <div class="job-action-panel job-action-panel--pay">
                <div style="font-size: 2rem; margin-bottom: 8px;">⏳</div>
                <h4>Subiri malipo ya escrow</h4>
                <p class="lead">Mteja amekuchagua kwa <strong>TZS <?php echo e(number_format($job->agreed_amount)); ?></strong>. Bado anahitaji kulipa kabla ya kazi kuanza rasmi. Utapata taarifa mteja akimaliza.</p>
              </div>
            <?php endif; ?>

            
            <?php if($isAssignedWorker && $job->status === \App\Models\Job::S_FUNDED): ?>
              <div class="job-action-panel job-action-panel--apply">
                <h4>💰 Escrow imewekwa</h4>
                <p class="lead">TZS <?php echo e(number_format($job->escrow_amount ?? $job->agreed_amount)); ?> zimehifadhiwa. <strong>Kubali</strong> kuanza kazi au <strong>kataa</strong> (malipo yatarudi kwa mteja).</p>
                <div style="display: grid; gap: 10px;">
                  <form method="POST" action="<?php echo e(route('jobs.worker.accept', $job)); ?>"><?php echo csrf_field(); ?><button type="submit" class="btn btn-success btn-full">✅ Kubali na anza kazi</button></form>
                  <form method="POST" action="<?php echo e(route('jobs.worker.decline', $job)); ?>"><?php echo csrf_field(); ?><button type="button" class="btn btn-danger btn-full" onclick="var f=this.closest('form'); (typeof tpConfirm==='function'?tpConfirm('Kataa kazi? Malipo yatarudishwa kwa muhitaji.'):Promise.resolve(confirm('Kataa kazi? Malipo yatarudishwa kwa muhitaji.'))).then(function(ok){ if(ok) f.submit(); });">❌ Kataa kazi</button></form>
                </div>
              </div>
            <?php endif; ?>

            
            <?php if($isAssignedWorker && $job->status === \App\Models\Job::S_IN_PROGRESS): ?>
              <div class="job-action-panel job-action-panel--progress">
                <h4>📋 Wasilisha kazi ukiisha</h4>
                <form method="POST" action="<?php echo e(route('jobs.worker.submit', $job)); ?>">
                  <?php echo csrf_field(); ?>
                  <div class="form-group">
                ...
                <form method="POST" action="<?php echo e(route('jobs.worker.dispute', $job)); ?>" style="margin-top: 10px;">
                  <?php echo csrf_field(); ?>
            ...
            <?php if($isClient && $job->status === \App\Models\Job::S_SUBMITTED): ?>
              <div class="job-action-panel job-action-panel--progress">
                ...
                <div style="display: grid; gap: 10px;">
                  ...
                  <div style="background: var(--job-glass-light); padding: 14px; border-radius: 12px; border: 1px solid var(--job-glass-border);">
                    ...
                    <form method="POST" action="<?php echo e(route('jobs.client.revision', $job)); ?>">
                      <?php echo csrf_field(); ?>
                  ...
                  <form method="POST" action="<?php echo e(route('jobs.client.dispute', $job)); ?>">
                    <?php echo csrf_field(); ?>
            ...
            <?php if($isAssignedWorker && $job->status === \App\Models\Job::S_SUBMITTED): ?>
              <div class="job-action-panel job-action-panel--status">
                ...
                <?php if($job->submitted_at): ?>
                  <p style="margin:0;font-size:0.8rem;color:var(--job-text-dim);">Wasilisho: <?php echo e($job->submitted_at->diffForHumans()); ?></p>
                <?php endif; ?>
              </div>
            <?php endif; ?>

            
            <?php if($job->status === \App\Models\Job::S_COMPLETED && ($isClient || $isAssignedWorker)): ?>
              <?php $existingReview = $job->reviews()->where('reviewer_id', auth()->id())->first(); ?>
              <?php if(!$existingReview): ?>
                <div class="job-action-panel job-action-panel--apply">
                  <h4>⭐ Toa tathmini</h4>
                  <p class="lead">Msaada wako unatusaidia kuendeleza uaminifu kwenye jukwaa.</p>
                  <form method="POST" action="<?php echo e(route('jobs.review', $job)); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="form-group">
                      ...
                      <div style="display: flex; gap: 8px;">
                        <?php for($i = 1; $i <= 5; $i++): ?>
                          <label style="cursor: pointer; font-size: 1.8rem; opacity: 0.5; transition: opacity 0.2s;" onmouseover="this.style.opacity=1" onmouseout="if(!this.querySelector('input').checked)this.style.opacity=0.5">
                            <input type="radio" name="rating" value="<?php echo e($i); ?>" required style="display: none;" onchange="this.closest('.form-group').querySelectorAll('label').forEach((l,idx)=>{l.style.opacity=idx<<?php echo e($i); ?>?'1':'0.5'})">⭐
                          </label>
                        <?php endfor; ?>
                      </div>
                    </div>
              ...
              <?php else: ?>
                <div style="background: var(--job-glass-light); border-radius: 14px; padding: 16px; margin-bottom: 24px; border: 1px solid var(--job-glass-border);">
                  <div style="color: #6ee7b7; font-weight: 600; font-size: 0.9rem;">✅ Umeshaweka review (<?php echo e($existingReview->rating); ?>/5)</div>
                </div>
              <?php endif; ?>
            <?php endif; ?>

            
            <?php if($isClient && $job->status === \App\Models\Job::S_OPEN): ?>
              <div class="tip-box">
            ...
            <?php elseif($isClient && $job->status === 'posted'): ?>
              <div class="tip-box">
            ...
            <?php if($isClient && in_array($job->status, [\App\Models\Job::S_OPEN, 'posted', 'pending_payment'], true)): ?>
              <form action="<?php echo e(route('jobs.cancel', $job)); ?>" method="POST" id="tp-cancel-job-form-<?php echo e($job->id); ?>">
                <?php echo csrf_field(); ?>
                <button type="button" class="btn btn-danger btn-full" onclick="var f=document.getElementById('tp-cancel-job-form-<?php echo e($job->id); ?>'); (typeof tpConfirm==='function'?tpConfirm('Una uhakika unataka kufuta kazi hii?'):Promise.resolve(confirm('Una uhakika unataka kufuta kazi hii?'))).then(function(ok){ if(ok) f.submit(); });">🗑️ Futa kazi</button>
              </form>
            <?php endif; ?>
          <?php endif; ?>
        </div>
        ...
        ?>
        <?php if($showEmployerApplicationsList): ?>
        <div id="maombi-panel" class="comments-section" style="margin-bottom: 16px;">
          <div class="comments-header">
            ...
            <div class="comments-count"><?php echo e($employerApplicationsList->count()); ?> maombi</div>
          </div>
          <p style="margin: 0 0 18px; font-size: 0.88rem; color: var(--job-text-muted); line-height: 1.5;">
            Hapa unaona maombi yote. Unaweza pia kuziangalia kwenye <a href="<?php echo e(route('my.applications')); ?>" style="color:var(--job-primary);font-weight:700;">Maombi yangu</a> (inbox). <strong>Huwezi kumchagua</strong> mfanyakazi mwenye counter hadi akubali bei yako.
          </p>
          ...
          <div class="comments-list">
            <?php $__currentLoopData = $employerApplicationsList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $app): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <?php
              ...
              <div class="comment-item"
                   style="<?php echo e($app->status === 'selected' ? 'border-color: rgba(16, 185, 129, 0.5); background: rgba(16, 185, 129, 0.05);' : ''); ?>

                          <?php echo e($app->status === 'rejected' ? 'opacity: 0.5;' : ''); ?>">
                <div class="comment-header">
                  <div class="comment-author" style="align-items: flex-start;">
                    <img src="<?php echo e($wAvatar); ?>" alt="" width="48" height="48" class="shrink-0 rounded-xl object-cover" style="width:48px;height:48px;border:1px solid var(--job-glass-border);">
                    <div class="min-w-0">
                      <span class="comment-author-name"><?php echo e($app->worker->name); ?></span>
                      <div style="font-size: 0.75rem; color: var(--job-text-dim);"><?php echo e($app->created_at->diffForHumans()); ?></div>
                    </div>
                  </div>
                  <div style="display: flex; gap: 6px; flex-wrap: wrap;">
                    <span style="background: rgba(99, 102, 241, 0.2); color: #a5b4fc; padding: 4px 10px; border-radius: 8px; font-size: 0.7rem; font-weight: 700;"><?php echo e($app->getStatusLabel()); ?></span>
                    <?php if($app->eta_text): ?>
                      <span style="background: rgba(245, 158, 11, 0.2); color: #fcd34d; padding: 4px 10px; border-radius: 8px; font-size: 0.7rem; font-weight: 700;">⏱ <?php echo e($app->eta_text); ?></span>
                    <?php endif; ?>
                  </div>
                </div>

                <div class="comment-message"><?php echo e($app->message); ?></div>

                
                <div class="comment-bid">
                  <span class="comment-bid-label">Bei Iliyopendekezwa:</span>
                  <span class="comment-bid-amount" style="<?php echo e($app->proposed_amount < $job->price ? 'color: #fcd34d;' : 'color: #6ee7b7;'); ?>">
                ...
                <?php if($app->isCountered()): ?>
                  <div style="background: linear-gradient(135deg, rgba(168, 85, 247, 0.15), rgba(168, 85, 247, 0.05)); border: 1px solid rgba(168, 85, 247, 0.3); border-radius: 12px; padding: 14px; margin-top: 14px;">
                    <div style="color: #c4b5fd; font-weight: 700; font-size: 0.85rem;">🔄 Counter Offer: TZS <?php echo e(number_format($app->counter_amount)); ?></div>
                    <?php if($app->client_response_note): ?>
                      <p style="color: var(--job-text-muted); font-size: 0.85rem; margin: 4px 0 0;">"<?php echo e($app->client_response_note); ?>"</p>
                    <?php endif; ?>
                  </div>
                <?php endif; ?>

                
                <?php if($canManageAppsHere && $app->isActive()): ?>
                  <div style="display: grid; gap: 10px; margin-top: 18px; padding-top: 14px; border-top: 1px solid var(--job-glass-border);">
                    ...
                    ?>
                    <?php if($app->isCountered()): ?>
                      <p style="margin: 0; font-size: 0.82rem; color: var(--job-text-muted); padding: 10px 12px; background: rgba(245, 158, 11, 0.1); border-radius: 10px; border: 1px solid rgba(245, 158, 11, 0.25);">⏳ Subiri <strong><?php echo e($app->worker->name); ?></strong> akubali counter offer ndipo uweze kumchagua.</p>
                    <?php endif; ?>
                    <?php if($canSelectThis): ?>
                      <form method="POST" action="<?php echo e(route('applications.select', [$job, $app])); ?>">
                        <?php echo csrf_field(); ?>
                        <button type="button" class="btn btn-success btn-full" onclick="var f=this.closest('form'); (typeof tpConfirm==='function'?tpConfirm(<?php echo json_encode('Chagua '.$app->worker->name.'? Utaelekezwa kulipa escrow.', 15, 512) ?>):Promise.resolve(confirm(<?php echo json_encode('Chagua '.$app->worker->name.'? Utaelekezwa kulipa escrow.', 15, 512) ?>))).then(function(ok){ if(ok) f.submit(); });">
                          ✅ Mchague <?php if($app->status === \App\Models\JobApplication::STATUS_ACCEPTED_COUNTER): ?>(TZS <?php echo e(number_format($app->counter_amount)); ?>)<?php else: ?><?php endif; ?>
                        </button>
                      </form>
                    <?php endif; ?>
                    ...
                    <?php if(! $app->isCountered()): ?>
                      <div style="background: var(--job-glass-light); padding: 14px; border-radius: 12px; border: 1px solid var(--job-glass-border);">
                        ...
                        <form method="POST" action="<?php echo e(route('applications.counter', [$job, $app])); ?>">
                          <?php echo csrf_field(); ?>
                    ...
                    <div style="display: flex; gap: 8px;">
                      <?php if($app->status !== 'shortlisted' && ! $app->isCountered()): ?>
                        <form method="POST" action="<?php echo e(route('applications.shortlist', [$job, $app])); ?>" style="flex: 1;">
                          <?php echo csrf_field(); ?>
                      ...
                      <?php endif; ?>
                      <form method="POST" action="<?php echo e(route('applications.reject', [$job, $app])); ?>" style="flex: 1;">
                        <?php echo csrf_field(); ?>
                        <button type="button" class="btn btn-danger btn-full" style="opacity: 0.75; font-size: 0.85rem;" onclick="var f=this.closest('form'); (typeof tpConfirm==='function'?tpConfirm(<?php echo json_encode('Kataa ombi la '.$app->worker->name.'?', 15, 512) ?>):Promise.resolve(confirm(<?php echo json_encode('Kataa ombi la '.$app->worker->name.'?', 15, 512) ?>))).then(function(ok){ if(ok) f.submit(); });">❌ Kataa</button>
                      </form>
                    </div>
                  </div>
                <?php endif; ?>
                ...
                <?php if($app->status === 'selected' && (auth()->id() === $job->user_id || auth()->id() === $app->worker_id)): ?>
                  <a href="<?php echo e(route('chat.show', $job)); ?>" class="btn btn-primary btn-full" style="margin-top: 14px;">💬 Fungua mazungumzo</a>
                <?php endif; ?>
              </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          </div>
        ...
        <div class="comments-section">
          ...
          <div class="comments-header">
            ...
            <div class="comments-count">
              <?php echo e($job->comments->count()); ?> Maoni
            </div>
          </div>

          <?php if(session('success') && $job->applications->count() === 0): ?>
            <div style="background: linear-gradient(135deg, rgba(16, 185, 129, 0.2), rgba(16, 185, 129, 0.1)); border-left: 4px solid #10b981; padding: 16px; border-radius: 12px; margin-bottom: 20px; color: #6ee7b7;">
              ✅ <?php echo e(session('success')); ?>
          ...
          <?php if(session('error') && $job->applications->count() === 0): ?>
            <div style="background: linear-gradient(135deg, rgba(239, 68, 68, 0.2), rgba(239, 68, 68, 0.1)); border-left: 4px solid #ef4444; padding: 16px; border-radius: 12px; margin-bottom: 20px; color: #fca5a5;">
              ❌ <?php echo e(session('error')); ?>
          ...
          <?php if(auth()->guard()->check()): ?>
            <?php if(auth()->user()->role === 'mfanyakazi' && $job->status === 'posted' && auth()->id() !== $job->user_id): ?>
              <form method="post" action="<?php echo e(route('jobs.comment', $job)); ?>" class="comment-form" id="comment-form">
                <?php echo csrf_field(); ?>
                <div class="form-group">
                ...
                <div class="form-group" id="bid-section" style="display: none;">
                  ...
                  <p style="font-size: 0.8rem; color: var(--job-text-dim); margin-top: 8px;">
                    Bei ya sasa: <strong style="color: #10b981;"><?php echo e(number_format($job->price)); ?> TZS</strong>
                  </p>
                </div>
            ...
            <?php elseif(auth()->user()->role === 'mfanyakazi' && $job->status !== 'posted'): ?>
            ...
            <?php if(auth()->user()->role === 'muhitaji' && auth()->id() === $job->user_id && in_array($job->status, ['posted', 'assigned'])): ?>
              <div class="job-card" style="margin-bottom: 24px; border: 1px dashed rgba(16, 185, 129, 0.4);">
                ...
                <form action="<?php echo e(route('jobs.increase-budget', $job)); ?>" method="POST" style="display: flex; gap: 12px; align-items: flex-end;">
                  <?php echo csrf_field(); ?>
                  <div style="flex: 1;">
                    <input 
                      type="number" 
          ...
          <?php else: ?>
            <div class="tip-box">
              ...
              <p class="tip-box-text">
                <a href="<?php echo e(route('login')); ?>" style="color: #fcd34d; text-decoration: underline;">Ingia</a> ili uweze kutuma maoni au kuomba kazi.
              </p>
            </div>
          <?php endif; ?>
          ...
          <!-- Comments List -->
          <div class="comments-list">
            <?php $__empty_1 = true; $__currentLoopData = $job->comments->whereNull('parent_id')->sortByDesc('created_at'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
              <div class="comment-item <?php echo e($comment->isApplication() ? 'is-application' : ''); ?> <?php echo e($comment->isOffer() ? 'is-offer' : ''); ?>" 
                   style="<?php echo e($comment->status === 'accepted' ? 'border-color: rgba(16, 185, 129, 0.5); background: rgba(16, 185, 129, 0.05);' : ''); ?>

                          <?php echo e($comment->status === 'rejected' ? 'opacity: 0.6;' : ''); ?>">
                
                <div class="comment-header">
                  <div class="comment-author">
                    <div class="comment-avatar" style="<?php echo e($comment->user->role === 'mfanyakazi' ? 'background: linear-gradient(135deg, #10b981, #059669);' : ''); ?>">
                      <?php echo e($comment->user->role === 'mfanyakazi' ? '👷' : '👤'); ?>

                    </div>
                    <div>
                      <span class="comment-author-name"><?php echo e($comment->user->name); ?></span>
                  ...
                  <div style="display: flex; gap: 8px; flex-wrap: wrap;">
                    ...
                    <?php elseif($comment->isApplication()): ?>
                    ...
                    <?php elseif($comment->status === 'countered'): ?>
                ...
                <?php if($comment->bid_amount): ?>
                  <div class="comment-bid" style="margin-top: 16px;">
                    ...
                    <span class="comment-bid-amount" style="<?php echo e($comment->bid_amount < $job->price ? 'color: #fcd34d;' : 'color: #6ee7b7;'); ?>">
                      <?php echo e(number_format($comment->bid_amount)); ?> TZS
                    </span>
                    <?php if($comment->bid_amount < $job->price): ?>
                      <span style="font-size: 0.75rem; color: #fcd34d; margin-left: 8px;">
                        (<?php echo e(number_format($job->price - $comment->bid_amount)); ?> chini)
                      </span>
                    <?php elseif($comment->bid_amount > $job->price): ?>
                      <span style="font-size: 0.75rem; color: #6ee7b7; margin-left: 8px;">
                        (+<?php echo e(number_format($comment->bid_amount - $job->price)); ?>)
                      </span>
                    <?php endif; ?>
                  </div>
                <?php endif; ?>
                ...
                <?php if($comment->status === 'countered' && $comment->counter_amount): ?>
                  <div style="background: linear-gradient(135deg, rgba(168, 85, 247, 0.15), rgba(168, 85, 247, 0.05)); border: 1px solid rgba(168, 85, 247, 0.3); border-radius: 12px; padding: 16px; margin-top: 16px;">
                    ...
                    <div style="font-size: 1.5rem; font-weight: 900; color: #c4b5fd;">
                      <?php echo e(number_format($comment->counter_amount)); ?> TZS
                    </div>
                    <?php if($comment->reply_message): ?>
                      <p style="color: var(--job-text-muted); font-size: 0.9rem; margin-top: 8px;">
                        "<?php echo e($comment->reply_message); ?>"
                      </p>
                    <?php endif; ?>
                    
                    <!-- Accept Counter Button for Mfanyakazi -->
                    <?php if(auth()->guard()->check()): ?>
                      <?php if(auth()->id() === $comment->user_id && $job->status === 'posted'): ?>
                        <form action="<?php echo e(route('jobs.accept-counter', [$job, $comment])); ?>" method="POST" style="margin-top: 12px;">
                          <?php echo csrf_field(); ?>
                ...
                <?php if($comment->reply_message && $comment->status !== 'countered'): ?>
                  <div style="background: var(--job-glass-light); border-left: 3px solid var(--job-primary); padding: 12px 16px; margin-top: 16px; border-radius: 0 12px 12px 0;">
                    <div style="font-size: 0.75rem; color: var(--job-text-dim); margin-bottom: 6px;">
                      💬 Jibu la Muhitaji (<?php echo e($comment->replied_at ? $comment->replied_at->diffForHumans() : ''); ?>):
                    </div>
                    <p style="margin: 0; color: var(--job-text);"><?php echo e($comment->reply_message); ?></p>
                  </div>
                <?php endif; ?>

                <!-- Action Buttons for Muhitaji -->
                <?php if(auth()->guard()->check()): ?>
                  <?php if(auth()->id() === $job->user_id && $job->status === 'posted' && $comment->user->role === 'mfanyakazi' && $comment->status === 'pending'): ?>
                    <div style="display: grid; gap: 12px; margin-top: 20px; padding-top: 16px; border-top: 1px solid var(--job-glass-border);">
                      
                      <!-- Accept Button -->
                      <form method="post" action="<?php echo e(route('jobs.accept', [$job, $comment])); ?>">
                        <?php echo csrf_field(); ?>
                        <button type="button" class="btn btn-success btn-full" onclick="var f=this.closest('form'); (typeof tpConfirm==='function'?tpConfirm(<?php echo json_encode('Uma uhakika unataka kumchagua '.$comment->user->name.'?', 15, 512) ?>):Promise.resolve(confirm(<?php echo json_encode('Uma uhakika unataka kumchagua '.$comment->user->name.'?', 15, 512) ?>))).then(function(ok){ if(ok) f.submit(); });">
                      ...
                      <?php if($comment->bid_amount || $comment->isOffer()): ?>
                        <div style="background: var(--job-glass-light); padding: 16px; border-radius: 12px; border: 1px solid var(--job-glass-border);">
                          ...
                          <form action="<?php echo e(route('jobs.counter', [$job, $comment])); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                      ...
                      <div style="background: var(--job-glass-light); padding: 16px; border-radius: 12px; border: 1px solid var(--job-glass-border);">
                        ...
                        <form action="<?php echo e(route('jobs.reply', [$job, $comment])); ?>" method="POST">
                          <?php echo csrf_field(); ?>
                      ...
                      <!-- Reject Button -->
                      <form action="<?php echo e(route('jobs.reject', [$job, $comment])); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <input type="hidden" name="reject_reason" value="Sio mfanyakazi tunayemhitaji kwa sasa.">
                        <button type="button" class="btn btn-danger btn-full" style="opacity: 0.8;" onclick="var f=this.closest('form'); (typeof tpConfirm==='function'?tpConfirm(<?php echo json_encode('Una uhakika unataka kumkataa '.$comment->user->name.'?', 15, 512) ?>):Promise.resolve(confirm(<?php echo json_encode('Una uhakika unataka kumkataa '.$comment->user->name.'?', 15, 512) ?>))).then(function(ok){ if(ok) f.submit(); });">
                          ❌ Mkatae
                        </button>
                      </form>
                    </div>
                  ...
                  <?php if(($job->accepted_worker_id === $comment->user_id && auth()->id() === $job->user_id) || 
                      ($job->accepted_worker_id === auth()->id() && $comment->user_id === auth()->id())): ?>
                    <a href="<?php echo e(route('chat.show', $job)); ?>" class="btn btn-primary btn-full" style="margin-top: 16px; display: flex; align-items: center; justify-content: center; gap: 8px;">
                      💬 Fungua Chat
                    </a>
                  <?php endif; ?>
                <?php endif; ?>
      ...
      <div>
        <?php if(auth()->guard()->check()): ?>
          <div class="job-side-flow">
            ...
            <ul class="job-flow-steps">
              <li class="<?php echo e($job->status === \App\Models\Job::S_OPEN ? 'is-current' : (in_array($job->status, [\App\Models\Job::S_AWAITING_PAYMENT, \App\Models\Job::S_FUNDED, \App\Models\Job::S_IN_PROGRESS, \App\Models\Job::S_SUBMITTED, \App\Models\Job::S_COMPLETED], true) ? 'is-done' : '')); ?>"><span class="step-idx">1</span><span><strong>Maombi</strong> → uchaguzi</span></li>
              <li class="<?php echo e($job->status === \App\Models\Job::S_AWAITING_PAYMENT ? 'is-current' : (in_array($job->status, [\App\Models\Job::S_FUNDED, \App\Models\Job::S_IN_PROGRESS, \App\Models\Job::S_SUBMITTED, \App\Models\Job::S_COMPLETED], true) ? 'is-done' : '')); ?>"><span class="step-idx">2</span><span><strong>Escrow</strong> (malipo)</span></li>
              <li class="<?php echo e(in_array($job->status, [\App\Models\Job::S_FUNDED, \App\Models\Job::S_IN_PROGRESS], true) ? 'is-current' : (in_array($job->status, [\App\Models\Job::S_SUBMITTED, \App\Models\Job::S_COMPLETED], true) ? 'is-done' : '')); ?>"><span class="step-idx">3</span><span><strong>Utekelezaji</strong></span></li>
              <li class="<?php echo e($job->status === \App\Models\Job::S_SUBMITTED ? 'is-current' : ($job->status === \App\Models\Job::S_COMPLETED ? 'is-done' : '')); ?>"><span class="step-idx">4</span><span><strong>Uthibitisho</strong></span></li>
              <li class="<?php echo e($job->status === \App\Models\Job::S_COMPLETED ? 'is-current is-done' : ''); ?>"><span class="step-idx">5</span><span><strong>Malipo</strong> kwa mfanyakazi</span></li>
            </ul>
        ...
        <div class="map-card" style="margin-bottom: 16px;">
          ...
          <div class="map-info">
            ...
            <div class="map-info-text">
              <h4>Eneo la Kazi</h4>
              <p><?php echo e($job->address_text ?? 'Eneo limewekwa kwenye ramani'); ?></p>
            </div>
          </div>
        </div>
          ...
          <div class="info-list">
            <div class="info-item">
              ...
              <div class="info-item-content">
                ...
                <div class="info-item-value"><?php echo e($job->category->name); ?></div>
              </div>
            </div>
              ...
              <div class="info-item-content">
                ...
                <div class="info-item-value">
                  <?php switch($job->status):
                    ...
                    <?php case ('expired'): ?> Imepitwa <?php break; ?>
                    <?php case ('posted'): ?> Imechapishwa <?php break; ?>
                    <?php case ('assigned'): ?> Imekabidhiwa <?php break; ?>
                    <?php case ('pending_payment'): ?> Inasubiri Malipo <?php break; ?>
                    <?php default: ?> <?php echo e(ucfirst(str_replace('_', ' ', $job->status))); ?>
            ...
            <div class="info-item">
              ...
              <div class="info-item-content">
                ...
                <div class="info-item-value"><?php echo e($job->created_at->format('d M Y')); ?></div>
              </div>
            </div>
            ...
            <div class="info-item">
              ...
              <div class="info-item-content">
                ...
                <div class="info-item-value"><?php echo e($job->applications()->count() ?: $job->comments->where('is_application', true)->count()); ?> maombi</div>
              </div>
            </div>
            ...
            <?php if($job->accepted_worker_id): ?>
              <div class="info-item" style="background: rgba(16, 185, 129, 0.15); border-color: rgba(16, 185, 129, 0.3);">
                ...
                <div class="info-item-content">
                  ...
                  <div class="info-item-value" style="color: #6ee7b7;"><?php echo e($job->acceptedWorker->name ?? 'N/A'); ?></div>
                </div>
              </div>
            <?php endif; ?>
          </div>
...
document.addEventListener('DOMContentLoaded', function() {
  // Initialize map
  <?php if($job->lat && $job->lng): ?>
    const map = L.map('map').setView([<?php echo e($job->lat); ?>, <?php echo e($job->lng); ?>], 14);
    ...
    L.marker([<?php echo e($job->lat); ?>, <?php echo e($job->lng); ?>], { icon: jobIcon })
      .addTo(map)
      .bindPopup('<strong><?php echo e($job->title); ?></strong><br><?php echo e($job->address_text ?? "Eneo la kazi"); ?>')
      .openPopup();
  <?php else: ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/eunice/GITHUB COOP/Tendapoa2/resources/views/jobs/show.blade.php ENDPATH**/ ?>
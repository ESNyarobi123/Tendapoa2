...
<body>
    <a href="<?php echo e(route('home')); ?>" class="back-home">← Rudi Nyumbani</a>
    ...
    <div class="container">
        ...
        <div class="brand-panel">
            <div class="brand-content">
                ...
                <div class="email-sent-box">
                    Msimbo umetumwa kwa:
                    <div class="email-addr"><?php echo e($email); ?></div>
                    <br>
        ...
        <div class="form-panel">
            ...
            <?php if(session('dev_otp')): ?>
                <div class="dev-box">
                    <div class="dev-box-label">🛠️ Dev Mode — Barua pepe haikutumwa</div>
                    <div class="dev-box-otp"><?php echo e(session('dev_otp')); ?></div>
            ...
            <form method="POST" action="<?php echo e(route('password.otp.verify')); ?>" id="otpForm" class="form-card">
                <?php echo csrf_field(); ?>
                ...
                <div class="otp-inputs" id="otpInputs">
                    <?php for($i = 0; $i < 6; $i++): ?>
                        <input type="text" class="otp-input" maxlength="1" inputmode="numeric" pattern="[0-9]" data-index="<?php echo e($i); ?>">
                    <?php endfor; ?>
                </div>
            ...
            <div class="form-footer">
                <a href="<?php echo e(route('login')); ?>" class="footer-link">← Rudi Ingia</a>
                <a href="<?php echo e(route('password.otp.request')); ?>" class="resend-link">Omba Msimbo Mpya</a>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        const timer = setInterval(() => {
            ...
            if (totalSeconds <= 0) {
                clearInterval(timer);
                timerEl.innerHTML = '⚠️ Msimbo umeisha muda. <a href="<?php echo e(route("password.otp.request")); ?>" style="color:#a5b4fc;font-weight:600">Omba Tena</a>';
...
<?php /**PATH /Users/eunice/GITHUB COOP/Tendapoa2/resources/views/auth/otp-verify.blade.php ENDPATH**/ ?>
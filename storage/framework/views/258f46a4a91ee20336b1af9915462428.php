<?php $__env->startSection('title', 'Chapisha kazi — mfanyakazi'); ?>
    ...
    <div class="w-full max-w-[min(100%,1400px)] space-y-4">
      ...
      <div class="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
        ...
        <div class="flex shrink-0 flex-wrap gap-2">
          <a href="<?php echo e(route('feed')); ?>" class="inline-flex items-center justify-center rounded-lg border border-slate-200 bg-white px-3 py-2 text-[12px] font-medium text-slate-700 shadow-sm hover:bg-slate-50">Tazama kazi</a>
      ...
      <nav class="rounded-2xl border border-slate-200 bg-white px-3 py-3 shadow-sm sm:px-5" aria-label="Hatua za fomu">
        <ol class="flex flex-wrap items-center gap-2 sm:gap-0" id="mfanyakazi-stepper">
          ...
          <?php $__currentLoopData = $steps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <li class="flex min-w-0 items-center <?php echo e($i > 0 ? 'sm:flex-1' : ''); ?>">
              <?php if($i > 0): ?>
                <div class="mx-1 hidden h-px min-w-[12px] flex-1 bg-slate-200 sm:block" data-step-connector="<?php echo e($s['n']); ?>" aria-hidden="true"></div>
              <?php endif; ?>
              <button
                type="button"
                class="mfanyakazi-step-tab flex items-center gap-2 rounded-xl px-2.5 py-2 text-left transition sm:px-3 <?php echo e($i === 0 ? 'bg-brand-50 ring-1 ring-brand-200' : 'hover:bg-slate-50'); ?>"
                data-go-step="<?php echo e($s['n']); ?>"
                aria-current="<?php echo e($i === 0 ? 'step' : 'false'); ?>"
              >
                <span class="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-slate-200 text-[11px] font-bold text-slate-700 tabular-nums" data-step-circle="<?php echo e($s['n']); ?>"><?php echo e($s['n']); ?></span>
                <span class="hidden text-[12px] font-semibold text-slate-800 sm:inline"><?php echo e($s['label']); ?></span>
              </button>
            </li>
                ...
                <div>
                  ...
                  >
                    ...
                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <option value="<?php echo e($c->id); ?>" <?php echo e((string) old('category_id') === (string) $c->id ? 'selected' : ''); ?>><?php echo e($c->name); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  </select>
                </div>
                <div>
                ...
                <div class="min-w-0 flex-1">
                  ...
                  <div class="mt-3 grid gap-2 sm:grid-cols-2 lg:grid-cols-1 xl:grid-cols-2">
                    ...
                    <div class="rounded-xl border border-slate-200/80 bg-white/90 px-3 py-2.5">
                      ...
                      <p class="mt-0.5 text-[15px] font-extrabold tabular-nums text-emerald-700"><?php echo e(number_format(optional(auth()->user()->wallet)->balance ?? 0)); ?></p>
                    </div>
                  </div>
...
<script>
  (function () {
    const TOTAL = 4;
    const INITIAL_STEP = <?php echo e((int) $mfanyakaziFormStep); ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/eunice/GITHUB COOP/Tendapoa2/resources/views/jobs/create-mfanyakazi.blade.php ENDPATH**/ ?>
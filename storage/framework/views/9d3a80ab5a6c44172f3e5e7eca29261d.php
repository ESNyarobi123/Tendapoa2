<?php $__env->startSection('title', 'Badilisha Kazi'); ?>
...
<div class="job-edit-page">
  <div class="page-container">
    ...
    <div class="form-container">
      <form method="POST" action="<?php echo e(route('jobs.update', $job)); ?>" id="editJobForm" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        ...
        <div class="form-group">
          ...
          <input type="text" id="title" name="title" class="form-input" 
                 value="<?php echo e(old('title', $job->title)); ?>" required maxlength="120">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group">
          ...
          <textarea id="description" name="description" class="form-input form-textarea" 
                    placeholder="Eleza kazi unayotaka kufanywa..."><?php echo e(old('description', $job->description)); ?></textarea>
          ...
          <div style="border: 2px dashed var(--border); border-radius: 12px; padding: 24px; text-align: center; background: #f9fafb; transition: all 0.3s ease; cursor: pointer;" id="image-upload-area" onclick="if(!document.getElementById('image-preview').style.display || document.getElementById('image-preview').style.display === 'none') document.getElementById('image').click()" ondrop="handleDrop(event)" ondragover="handleDragOver(event)" ondragleave="handleDragLeave(event)">
            ...
            <?php if($job->image): ?>
              <div id="image-current" style="margin-bottom: 16px;">
                ...
                <img src="<?php echo e(Storage::url($job->image)); ?>" alt="Current image" style="max-width: 100%; max-height: 200px; border-radius: 12px; box-shadow: var(--shadow);" onerror="this.parentElement.style.display='none';">
              </div>
            <?php endif; ?>
            <div id="image-upload-placeholder" <?php if($job->image): ?> style="display: none;" <?php endif; ?>>
              ...
              <button type="button" onclick="document.getElementById('image').click()" class="btn btn-outline" style="margin-top: 16px;">
                <span>📁</span>
                <?php echo e($job->image ? 'Badilisha Picha' : 'Chagua Picha'); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="price-section">
          ...
          <div class="current-price">
            ...
            <div class="current-price-value"><?php echo e(number_format($job->price)); ?> TZS</div>
          </div>

          <div class="form-group">
            <label for="price" class="form-label">Bei Mpya (TZS)</label>
            <input type="number" id="price" name="price" class="form-input" 
                   value="<?php echo e(old('price', $job->price)); ?>" required min="<?php echo e($job->price); ?>" 
                   step="100" placeholder="Weka bei mpya" 
                   data-current-price="<?php echo e($job->price ?? 0); ?>">
          ...
          <div class="location-grid">
            <div class="form-group">
              ...
              <input type="number" id="lat" name="lat" class="form-input" 
                     value="<?php echo e(old('lat', $job->lat)); ?>" required step="any" 
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
              ...
              <input type="number" id="lng" name="lng" class="form-input" 
                     value="<?php echo e(old('lng', $job->lng)); ?>" required step="any" 
...
unset($__errorArgs, $__bag); ?>
          ...
          <div class="form-group">
            ...
            <input type="text" id="address_text" name="address_text" class="form-input" 
                   value="<?php echo e(old('address_text', $job->address_text)); ?>" 
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-actions">
          <a href="<?php echo e(route('my.jobs')); ?>" class="btn btn-outline">
            <span>❌</span>
            Ghairi
          </a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/eunice/GITHUB COOP/Tendapoa2/resources/views/jobs/edit.blade.php ENDPATH**/ ?>
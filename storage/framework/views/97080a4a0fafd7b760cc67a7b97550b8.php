<?php $__env->startSection('title', 'Chapisha Kazi'); ?>
  ...
  <main class="tp-main w-full min-w-0 p-4 pt-16 sm:p-6 lg:pt-6">
    <div class="mx-auto w-full max-w-[min(100%,1400px)] space-y-5 pb-10">
      ...
      <nav class="mb-0" aria-label="Hatua">
        <ol class="grid grid-cols-4 gap-1.5 sm:gap-3" id="stepper">
          <?php $__currentLoopData = [
            ...
            <li>
              <button type="button" data-goto-step="<?php echo e($s['n']); ?>" class="step-pill group flex w-full flex-col items-center gap-1 rounded-xl border border-slate-200 bg-white px-1 py-2.5 text-center shadow-sm transition hover:border-brand-200 sm:flex-row sm:justify-center sm:gap-2 sm:px-2" data-step="<?php echo e($s['n']); ?>">
                <span class="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-slate-100 text-[15px] leading-none transition group-[.is-active]:bg-brand-600 group-[.is-active]:text-white group-[.is-done]:bg-emerald-500 group-[.is-done]:text-white"><?php echo e($s['emoji']); ?></span>
                <span class="text-[9px] font-bold uppercase leading-tight tracking-wide text-slate-500 group-[.is-active]:text-brand-800 sm:text-[10px]"><?php echo e($s['label']); ?></span>
              </button>
            </li>
      ...
      <div class="overflow-hidden rounded-2xl border border-slate-200/80 bg-white shadow-lg ring-1 ring-slate-100/80">
        ...
        <form method="post" action="<?php echo e(route('jobs.store')); ?>" enctype="multipart/form-data" id="jobCreateForm" class="p-5 sm:p-8">
          <?php echo csrf_field(); ?>
          ...
          <div class="job-step space-y-5" data-step-panel="1">
            ...
            <div>
              ...
              <textarea name="description" id="description" rows="4"
                ...
                placeholder="Muda, ukubwa wa nyumba, vifaa mteja atatoa, n.k."><?php echo e(old('description')); ?></textarea>
            </div>
          </div>
              ...
              <div class="space-y-3 border-t border-slate-100 bg-slate-50/80 p-4">
                ...
                <div>
                  ...
                  <input type="text" name="address_text" id="address_text"
                    ...
                    value="<?php echo e(old('address_text')); ?>">
                </div>
        ...
        <aside class="min-w-0 lg:col-span-5 xl:col-span-4">
          <div class="sticky top-20 space-y-4">
            <section class="rounded-2xl border border-brand-200 bg-gradient-to-br from-brand-50 to-teal-50/30 p-4 shadow-sm sm:p-5">
              ...
              <ol class="mt-3 space-y-3 text-[11px] leading-relaxed text-slate-700">
                ...
                <li class="flex gap-2.5">
                  ...
                  <span><strong class="text-slate-900">Maombi</strong> — pitia na uchague mfanyakazi kwenye <a href="<?php echo e(route('my.applications')); ?>" class="font-semibold text-brand-700 underline decoration-brand-300 underline-offset-2">Maombi yangu</a>.</span>
                </li>
                <li class="flex gap-2.5">
            ...
            <section class="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm sm:p-5">
              ...
              <p class="mt-0.5 text-2xl font-extrabold tabular-nums text-emerald-700"><?php echo e(number_format($wCreate->available_balance)); ?> <span class="text-sm font-bold text-emerald-600/90">TZS</span></p>
              <?php if((int) $wCreate->held_balance > 0): ?>
                <p class="mt-2 text-[11px] text-slate-500">Imeshikiliwa (escrow nyingine): <span class="font-semibold tabular-nums text-slate-700"><?php echo e(number_format($wCreate->held_balance)); ?> TZS</span></p>
              <?php endif; ?>
              <div class="mt-4 flex flex-col gap-2 sm:flex-row">
                <a href="<?php echo e(route('wallet.deposit')); ?>" class="inline-flex flex-1 items-center justify-center rounded-xl bg-brand-600 px-3 py-2.5 text-[12px] font-bold text-white shadow-sm hover:bg-brand-700">Weka pesa</a>
                <a href="<?php echo e(route('withdraw.form')); ?>" class="inline-flex flex-1 items-center justify-center rounded-xl border border-slate-200 bg-white px-3 py-2.5 text-[12px] font-semibold text-slate-700 shadow-sm hover:bg-slate-50">Toa pesa</a>
              </div>
            </section>
...
(function () {
  const TOTAL = 4;
  let currentStep = <?php echo e((int) $errStep); ?>;
  let map = null;
  let marker = null;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/eunice/GITHUB COOP/Tendapoa2/resources/views/jobs/create.blade.php ENDPATH**/ ?>
...
<aside class="tp-sidebar" id="sidebar">
  ...
  <!-- Profile -->
  <a href="<?php echo e(route('profile.edit')); ?>" class="tp-profile">
    <img src="<?php echo e($user->profile_photo_url ?? ''); ?>" alt="" class="tp-avatar">
    <div class="tp-profile-info">
      <div class="tp-profile-name"><?php echo e($user->name); ?></div>
      <div class="tp-profile-role"><?php echo e($isMuhitaji ? 'Mteja' : 'Mfanyakazi'); ?></div>
    </div>
  </a>

  <!-- Menu -->
  <nav class="tp-menu">
    <a href="<?php echo e(route('dashboard')); ?>" class="tp-menu-item <?php echo e(request()->routeIs('dashboard') ? 'active' : ''); ?>">
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="14" y="14" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/></svg>
      <span class="tp-menu-text">Dashibodi</span>
    </a>

    <a href="<?php echo e(route('notifications.index')); ?>" class="tp-menu-item <?php echo e(request()->routeIs('notifications.index') ? 'active' : ''); ?>">
      <span class="tp-icon-wrap">
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 0 1-3.46 0"/></svg>
        <?php if($unreadCount > 0): ?><span class="tp-notif-dot"></span><?php endif; ?>
      </span>
      <span class="tp-menu-text">Taarifa</span>
      <?php if($unreadCount > 0): ?><span class="tp-badge-count"><?php echo e($unreadCount); ?></span><?php endif; ?>
    </a>

    <div class="tp-menu-divider"></div>

    <?php if($isMuhitaji): ?>
      <a href="<?php echo e(route('jobs.create')); ?>" class="tp-menu-item <?php echo e(request()->routeIs('jobs.create') ? 'active' : ''); ?>">
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg>
        <span class="tp-menu-text">Chapisha Kazi</span>
      </a>
      <a href="<?php echo e(route('my.jobs')); ?>" class="tp-menu-item <?php echo e(request()->routeIs('my.jobs') ? 'active' : ''); ?>">
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>
        <span class="tp-menu-text">Kazi Zangu</span>
      </a>
      <a href="<?php echo e(route('my.applications')); ?>" class="tp-menu-item <?php echo e(request()->routeIs('my.applications') ? 'active' : ''); ?>">
        <span class="tp-icon-wrap">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
          <?php if(($pendingAppsCount ?? 0) > 0): ?><span class="tp-notif-dot"></span><?php endif; ?>
        </span>
        <span class="tp-menu-text">Maombi</span>
        <?php if(($pendingAppsCount ?? 0) > 0): ?><span class="tp-badge-count"><?php echo e($pendingAppsCount); ?></span><?php endif; ?>
      </a>
      <a href="<?php echo e(route('my.jobs', ['status' => 'awaiting_payment'])); ?>" class="tp-menu-item <?php echo e(request()->fullUrlIs(route('my.jobs', ['status' => 'awaiting_payment'])) ? 'active' : ''); ?>">
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>
        <span class="tp-menu-text">Lipia Escrow</span>
      </a>
      <a href="<?php echo e(route('wallet.deposit')); ?>" class="tp-menu-item <?php echo e(request()->routeIs('wallet.deposit', 'wallet.deposit.submit', 'wallet.deposit.wait', 'wallet.deposit.poll') ? 'active' : ''); ?>">
      ...
      <a href="<?php echo e(route('withdraw.form')); ?>" class="tp-menu-item <?php echo e(request()->routeIs('withdraw.*') ? 'active' : ''); ?>">
    ...
    <?php elseif($isMfanyakazi): ?>
      <a href="<?php echo e(route('feed')); ?>" class="tp-menu-item <?php echo e(request()->routeIs('feed') ? 'active' : ''); ?>">
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.35-4.35"/></svg>
        <span class="tp-menu-text">Tafuta Kazi</span>
      </a>
      <a href="<?php echo e(route('mfanyakazi.assigned')); ?>" class="tp-menu-item <?php echo e(request()->routeIs('mfanyakazi.assigned') ? 'active' : ''); ?>">
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>
        <span class="tp-menu-text">Kazi Zangu</span>
      </a>
      <a href="<?php echo e(route('mfanyakazi.applications')); ?>" class="tp-menu-item <?php echo e(request()->routeIs('mfanyakazi.applications') ? 'active' : ''); ?>">
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 11l3 3L22 4"/><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"/></svg>
        <span class="tp-menu-text">Maombi yangu</span>
      </a>
      <a href="<?php echo e(route('jobs.create-mfanyakazi')); ?>" class="tp-menu-item <?php echo e(request()->routeIs('jobs.create-mfanyakazi') ? 'active' : ''); ?>">
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg>
      ...
      <a href="<?php echo e(route('my.jobs')); ?>" class="tp-menu-item <?php echo e(request()->routeIs('my.jobs') ? 'active' : ''); ?>">
        ...
        <span class="tp-menu-text">Huduma Nilizopost</span>
      </a>
      <a href="<?php echo e(route('my.applications')); ?>" class="tp-menu-item <?php echo e(request()->routeIs('my.applications') ? 'active' : ''); ?>">
        <span class="tp-icon-wrap">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
        </span>
        <span class="tp-menu-text">Maombi kwa huduma zangu</span>
      </a>
      <a href="<?php echo e(route('wallet.deposit')); ?>" class="tp-menu-item <?php echo e(request()->routeIs('wallet.deposit', 'wallet.deposit.submit', 'wallet.deposit.wait', 'wallet.deposit.poll') ? 'active' : ''); ?>">
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"/><polyline points="19 12 12 19 5 12"/></svg>
        <span class="tp-menu-text">Weka pesa</span>
    ...
    <a href="<?php echo e(route('chat.index')); ?>" class="tp-menu-item <?php echo e(request()->routeIs('chat.*') ? 'active' : ''); ?>">
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>
      <span class="tp-menu-text">Mazungumzo</span>
    </a>
    <a href="<?php echo e(route('home')); ?>" class="tp-menu-item">
...
</script><?php /**PATH /Users/eunice/GITHUB COOP/Tendapoa2/resources/views/components/user-sidebar.blade.php ENDPATH**/ ?>
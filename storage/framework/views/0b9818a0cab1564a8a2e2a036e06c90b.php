        ...
        <div class="nav-container">
            ...
            <nav class="nav-links" id="navLinks">
                ...
                <?php if(Route::has('login')): ?>
                    ...
                    <?php else: ?>
                        <a href="<?php echo e(route('login')); ?>" class="btn btn-outline">Ingia</a>
    ...
    <section class="cta-section">
        <div class="container">
            <div class="cta-content">
                ...
                <a href="<?php echo e(route('register')); ?>" class="btn btn-primary" style="background: white; color: #2563eb; font-size: 1rem; padding: 1rem 2rem;">
                    Pata Huduma
                </a>
            </div>
        </div>
    ...
    <footer class="footer">
        <div class="footer-content">
            <div>
                ...
                <p style="color: rgba(255, 255, 255, 0.6); font-size: 0.875rem;">Hakimiliki © <?php echo e(date('Y')); ?> Tendapoa. Haki zote zimehifadhiwa.</p>
            </div>
            <div>
                <h3>Navigation</h3>
...
<?php /**PATH /Users/eunice/GITHUB COOP/Tendapoa2/resources/views/welcome.blade.php ENDPATH**/ ?>
...
<div class="page-container">
    ...
    <div class="page-header">
      <div class="header-content">
        ...
        <div class="header-actions">
          ...
          <a class="btn btn-primary" href="<?php echo e(url('/admin/users/export')); ?>">
            <span>📊</span>
            Export Users
          </a>
        </div>
    ...
    <div class="stats-grid">
      ...
      <div class="stat-card">
        <div class="stat-icon">👷</div>
        <div class="stat-value"><?php echo e($users->where('role', 'mfanyakazi')->count()); ?></div>
        <div class="stat-label">Workers</div>
      </div>
      <div class="stat-card">
        <div class="stat-icon">🧑‍💼</div>
        <div class="stat-value"><?php echo e($users->where('role', 'muhitaji')->count()); ?></div>
        <div class="stat-label">Clients</div>
      </div>
      <div class="stat-card">
        <div class="stat-icon">🛠️</div>
        <div class="stat-value"><?php echo e($users->where('role', 'admin')->count()); ?></div>
        ...
        <table class="users-table">
          ...
          <tbody>
            <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <tr class="user-row" data-role="<?php echo e($user->role); ?>" data-status="<?php echo e($user->email_verified_at ? 'active' : 'inactive'); ?>">
                <td>
                  <div class="user-info">
                ...
                <td>
                  <span class="status-badge <?php echo e($user->email_verified_at ? 'active' : 'inactive'); ?>">
                    <?php echo e($user->email_verified_at ? 'Active' : 'Inactive'); ?>

                  </span>
                </td>
                <td><?php echo e($user->created_at?->format('M d, Y') ?? 'N/A'); ?></td>
                <td><?php echo e($user->updated_at?->diffForHumans() ?? 'N/A'); ?></td>
                <td>
                  <div style="display: flex; gap: 8px; flex-wrap: wrap;">
                    <a class="btn btn-outline" href="<?php echo e(route('admin.user.details', $user)); ?>">
                      <span>👁️</span>
                      View
                    </a>
                    <?php if($user->role !== 'admin'): ?>
                      <form method="POST" action="<?php echo e(route('admin.user.toggle-status', $user)); ?>" class="inline" style="display:inline;">
                        <?php echo csrf_field(); ?>
                    ...
                    <?php endif; ?>
                    <?php if($user->role !== 'admin'): ?>
                      <form method="POST" action="<?php echo e(route('admin.user.delete', $user)); ?>" class="inline" style="display:inline;" onsubmit="return false;">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/eunice/GITHUB COOP/Tendapoa2/resources/views/admin/users.blade.php ENDPATH**/ ?>
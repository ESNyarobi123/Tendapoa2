...
<body>
    <div class="wrapper">
        ...
        <div class="body">
            <div class="greeting">Habari <?php echo e($userName); ?>,</div>
        ...
        <div class="footer">
            <p>Barua hii imetumwa na <a href="<?php echo e(config('app.url')); ?>">TendaPoa</a></p>
            <p>© <?php echo e(date('Y')); ?> TendaPoa. Haki zote zimehifadhiwa.</p>
        </div>
    </div>
</body>
</html>
<?php /**PATH /Users/eunice/GITHUB COOP/Tendapoa2/resources/views/emails/otp-password-reset.blade.php ENDPATH**/ ?>
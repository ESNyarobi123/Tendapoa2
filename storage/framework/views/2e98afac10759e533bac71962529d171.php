...
<body>
    ...
    <div class="container">
        ...
        <div class="form-panel">
            ...
            <form method="POST" action="<?php echo e(route('password.otp.send')); ?>" class="form-card">
                <?php echo csrf_field(); ?>
            ...
            <div class="form-footer">
                ...
                <a href="<?php echo e(route('login')); ?>" class="back-link">← Rudi kwenye Ingia</a>
            </div>
        </div>
    </div>
...
<?php /**PATH /Users/eunice/GITHUB COOP/Tendapoa2/resources/views/auth/otp-request.blade.php ENDPATH**/ ?>
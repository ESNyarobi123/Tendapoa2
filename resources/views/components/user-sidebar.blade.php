@php
  ...
  $brandLogoUrl = asset('images/brand/tendapoa-logo.jpg');
@endphp
...
<aside class="tp-sidebar" id="sidebar">
  ...
  <div class="tp-sidebar-brand">
    <img src="{{ $brandLogoUrl }}" alt="TendaPoa" class="tp-brand-icon-img" width="32" height="32">
  ...
  <nav class="tp-menu">
    ...
    @if($isMuhitaji)
      ...
      <a href="{{ route('services.index') }}" class="tp-menu-item {{ request()->routeIs('services.*') ? 'active' : '' }}">
        ...
        <span class="tp-menu-text">Huduma</span>
      </a>
